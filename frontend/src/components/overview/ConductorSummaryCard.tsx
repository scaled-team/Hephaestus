  ...
  return (
    <Card className={cn(OVERVIEW_CARD)}>
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Badge
              variant="outline"
              className={
                coherencePercent >= 80 ? "bg-green-50 dark:bg-green-900 text-green-700 dark:text-green-200 dark:border-green-700" :
                coherencePercent >= 50 ? "bg-yellow-50 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-200 dark:border-yellow-700" :
                "bg-red-50 dark:bg-red-900 text-red-700 dark:text-red-200 dark:border-red-700"
              }
            >
      ...
      <CardContent className="space-y-4">
        {/* System Status */}
        <div className={cn(OVERVIEW_SURFACE, "p-4")}>
        ...
        {analysis.detected_duplicates && analysis.detected_duplicates.length > 0 && (
          <Alert className={cn(OVERVIEW_SURFACE, "border-yellow-200 dark:border-yellow-800 bg-yellow-50/80 dark:bg-yellow-900/20")}>
              ...
              <ScrollArea className="h-24">
                <div className="space-y-2">
                  {analysis.detected_duplicates.map((dup, idx) => (
                    <div key={idx} className="text-sm text-yellow-700 dark:text-yellow-300 flex items-start">
        ...
        {analysis.recommendations && (
          <div className={cn(OVERVIEW_SURFACE, "p-4 border border-blue-200/70 dark:border-blue-900/40 bg-blue-50/80 dark:bg-blue-900/20")}>
        ...
        <div className="border-t border-gray-200/70 dark:border-white/5 pt-4">
          <Button
            ...
            className="w-full justify-between text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200"
          >
