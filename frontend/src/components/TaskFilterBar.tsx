...
const TaskFilterBar: React.FC<TaskFilterBarProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 dark:from-gray-800 dark:via-gray-800/95 dark:to-gray-900/90 rounded-xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
      {/* Header with Search */}
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-gray-200/50 dark:border-gray-700/50 p-5">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-3.5 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 transition-all text-sm placeholder:text-gray-400 dark:placeholder:text-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
          />
          {filters.searchText && (
            <button
      ...
      {(activeFiltersCount > 0 || filteredCount !== tasks.length) && (
        <div className="bg-blue-50/50 dark:bg-blue-900/20 backdrop-blur-sm border-b border-blue-100 dark:border-blue-800/50 px-5 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {activeFiltersCount > 0 && (
                <span className="px-2.5 py-0.5 bg-blue-500 dark:bg-blue-600 text-white rounded-full text-xs font-bold">
              ...
              >
                {activeFiltersList.map((filter) => (
                  <motion.div
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-gray-700 border border-blue-200 dark:border-blue-700 rounded-full text-xs font-medium shadow-sm"
                  >
                    <span className="text-blue-600 dark:text-blue-400 font-bold">{filter.label}:</span>
                    <span className="text-gray-700 dark:text-gray-200">{filter.value}</span>
                    <button
                      onClick={() => removeFilter(filter.key)}
                      className="ml-0.5 hover:bg-blue-100 dark:hover:bg-blue-800/50 rounded-full p-0.5 transition-colors"
                      title="Remove filter"
                    >
      ...
      <div className="p-5 space-y-5">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wide">Status</h3>
          </div>
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive
                      ? 'bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 text-white shadow-md scale-105 ring-2 ring-blue-300 dark:ring-blue-500'
                      : isEmpty
                      ? 'bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-600 cursor-not-allowed'
                      : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 hover:shadow-sm'
                    }
                  `}
                >
                  <span className="mr-1.5">{status.emoji}</span>
                  {status.label}
                  <span className={`ml-2 ${isActive ? 'text-blue-100' : 'text-gray-500 dark:text-gray-400'} font-bold`}>
                    {count}
                  </span>
                </button>
              );
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wide">Phase</h3>
          </div>
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`
                px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200
                ${filters.phase === 'all'
                  ? 'bg-gradient-to-r from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 text-white shadow-md scale-105 ring-2 ring-green-300 dark:ring-green-500'
                  : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 hover:border-green-300 dark:hover:border-green-500 hover:shadow-sm'
                }
              `}
            >
              All Phases
              <span className={`ml-2 ${filters.phase === 'all' ? 'text-green-100' : 'text-gray-500 dark:text-gray-400'} font-bold`}>
                {tasks.length}
              </span>
            </button>
            <button
            ...
            >
              No Phase
              <span className={`ml-2 ${filters.phase === 'no-phase' ? 'text-green-100' : 'text-gray-500 dark:text-gray-400'} font-bold`}>
            ...
            {sortedPhases.map((phase) => {
              ...
              return (
                ...
                >
                  Phase {phase.order}: {phase.name}
                  <span className={`ml-2 ${isActive ? 'text-green-100' : 'text-gray-500 dark:text-gray-400'} font-bold`}>
                    {phase.count}
                  </span>
                </button>
              );
        ...
        <div className="pt-3 border-t border-gray-200 dark:border-gray-700">
          ...
          >
            ...
            {(filters.priority !== 'all' || filters.assignment !== 'all' || filters.dateRange !== 'all') && (
              <span className="px-2 py-0.5 bg-purple-500 dark:bg-purple-600 text-white rounded-full text-xs font-bold">
                Active
              </span>
            )}
          </button>
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wide">Priority</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  {priorities.map((priority) => {
                    ...
                    const colors = {
                      high: 'from-red-500 to-red-600 dark:from-red-600 dark:to-red-700 ring-red-300 dark:ring-red-500',
                      medium: 'from-yellow-500 to-yellow-600 dark:from-yellow-600 dark:to-yellow-700 ring-yellow-300 dark:ring-yellow-500',
                      low: 'from-gray-500 to-gray-600 dark:from-gray-600 dark:to-gray-700 ring-gray-300 dark:ring-gray-500',
                      all: 'from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 ring-purple-300 dark:ring-purple-500',
                    };
                      ...
                      <button
                        ...
                        className={`
                          ...
                          ${isActive
                            ...
                            : isEmpty
                            ? 'bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-600 cursor-not-allowed'
                            : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 hover:border-purple-300 dark:hover:border-purple-500 hover:shadow-sm'
                          }
                        `}
                      >
                        {priority.label}
                        <span className={`ml-2 ${isActive ? 'opacity-80' : 'text-gray-500 dark:text-gray-400'} font-bold`}>
                          {count}
                        </span>
                      </button>
                    );
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wide">Assignment</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                    ...
                    return (
                      <button
                        ...
                        className={`
                          px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200
                          ${isActive
                            ? 'bg-gradient-to-r from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 text-white shadow-md scale-105 ring-2 ring-purple-300 dark:ring-purple-500'
                            : isEmpty
                            ? 'bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-600 cursor-not-allowed'
                            : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 hover:border-purple-300 dark:hover:border-purple-500 hover:shadow-sm'
                          }
                      ...
                      >
                        {assignment.label}
                        <span className={`ml-2 ${isActive ? 'text-purple-100' : 'text-gray-500 dark:text-gray-400'} font-bold`}>
                          {count}
                        </span>
                      </button>
                    );
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wide">Created</h3>
                </div>
                <div className="flex flex-wrap gap-2">
